...
const fallbackRows = [
    ...
    { stockId: 2, symbol: "MSFT", name: "Microsoft Corporation", marketCap: 3100000000000, industry: "Technology", price: 0, marketPriceChgPct: 5.71 },
    { stockId: 3, symbol: "NVDA", name: "NVIDIA Corporation", marketCap: 2900000000000, industry: "Semiconductors", price: 0, marketPriceChgPct: -1.64 },
    { stockId: 4, symbol: "AVGO", name: "Broadcom Inc", marketCap: 760000000000, industry: "Semiconductors", price: 0, marketPriceChgPct: -3.67 },
    { stockId: 5, symbol: "ORCL", name: "Oracle Corporation", marketCap: 480000000000, industry: "Technology", price: 0, marketPriceChgPct: -2.58 },
    { stockId: 6, symbol: "PLTR", name: "Palantir Technologies", marketCap: 160000000000, industry: "Technology", price: 0, marketPriceChgPct: 5.28 },
    { stockId: 7, symbol: "AMD", name: "Advanced Micro Devices", marketCap: 250000000000, industry: "Semiconductors", price: 0, marketPriceChgPct: -2.06 },
    { stockId: 8, symbol: "QCOM", name: "Qualcomm", marketCap: 230000000000, industry: "Semiconductors", price: 0, marketPriceChgPct: -7.57 },
    ...
    { stockId: 15, symbol: "GOOGL", name: "Alphabet Inc", marketCap: 2100000000000, industry: "Communication Services", price: 0, marketPriceChgPct: -1.84 },
    { stockId: 16, symbol: "META", name: "Meta Platforms Inc", marketCap: 1200000000000, industry: "Communication Services", price: 0, marketPriceChgPct: 1.36 },
    { stockId: 17, symbol: "NFLX", name: "Netflix Inc", marketCap: 290000000000, industry: "Communication Services", price: 0, marketPriceChgPct: 4.10 },
    ...
    { stockId: 22, symbol: "AMZN", name: "Amazon.com Inc", marketCap: 1900000000000, industry: "Consumer Cyclical", price: 0, marketPriceChgPct: 2.50 },
    { stockId: 23, symbol: "TSLA", name: "Tesla Inc", marketCap: 600000000000, industry: "Automotive", price: 0, marketPriceChgPct: 1.22 },
    { stockId: 24, symbol: "HD", name: "Home Depot", marketCap: 360000000000, industry: "Consumer Cyclical", price: 0, marketPriceChgPct: 0.44 },
    { stockId: 25, symbol: "MCD", name: "McDonald's", marketCap: 220000000000, industry: "Consumer Cyclical", price: 0, marketPriceChgPct: 1.97 },
    { stockId: 26, symbol: "BKNG", name: "Booking Holdings", marketCap: 180000000000, industry: "Consumer Cyclical", price: 0, marketPriceChgPct: -0.46 },
    ...
    { stockId: 30, symbol: "JPM", name: "JPMorgan Chase & Co", marketCap: 550000000000, industry: "Financial Services", price: 0, marketPriceChgPct: -1.81 },
    { stockId: 31, symbol: "V", name: "Visa Inc", marketCap: 520000000000, industry: "Financial Services", price: 0, marketPriceChgPct: 1.73 },
    { stockId: 32, symbol: "MA", name: "Mastercard", marketCap: 430000000000, industry: "Financial Services", price: 0, marketPriceChgPct: 2.07 },
    { stockId: 33, symbol: "BAC", name: "Bank of America", marketCap: 310000000000, industry: "Financial Services", price: 0, marketPriceChgPct: -0.53 },
    { stockId: 34, symbol: "WFC", name: "Wells Fargo", marketCap: 210000000000, industry: "Financial Services", price: 0, marketPriceChgPct: -1.04 },
    ...
    { stockId: 39, symbol: "BX", name: "Blackstone", marketCap: 160000000000, industry: "Financial Services", price: 0, marketPriceChgPct: 1.07 },
    { stockId: 40, symbol: "WMT", name: "Walmart", marketCap: 530000000000, industry: "Consumer Defensive", price: 0, marketPriceChgPct: -0.08 },
    { stockId: 41, symbol: "COST", name: "Costco", marketCap: 410000000000, industry: "Consumer Defensive", price: 0, marketPriceChgPct: 1.09 },
    ...
    { stockId: 43, symbol: "KO", name: "Coca-Cola", marketCap: 300000000000, industry: "Consumer Defensive", price: 0, marketPriceChgPct: 2.75 },
    ...
    { stockId: 47, symbol: "LLY", name: "Eli Lilly and Company", marketCap: 850000000000, industry: "Healthcare", price: 0, marketPriceChgPct: 7.13 },
    { stockId: 48, symbol: "JNJ", name: "Johnson & Johnson", marketCap: 370000000000, industry: "Healthcare", price: 0, marketPriceChgPct: 3.99 },
    { stockId: 49, symbol: "UNH", name: "UnitedHealth", marketCap: 460000000000, industry: "Healthcare", price: 0, marketPriceChgPct: 2.98 },
    { stockId: 50, symbol: "ABBV", name: "AbbVie", marketCap: 330000000000, industry: "Healthcare", price: 0, marketPriceChgPct: 4.20 },
    { stockId: 51, symbol: "MRK", name: "Merck", marketCap: 320000000000, industry: "Healthcare", price: 0, marketPriceChgPct: 2.56 },
    ...
    { stockId: 55, symbol: "PFE", name: "Pfizer", marketCap: 150000000000, industry: "Healthcare", price: 0, marketPriceChgPct: 0.53 },
    { stockId: 56, symbol: "XOM", name: "Exxon Mobil Corporation", marketCap: 470000000000, industry: "Energy", price: 0, marketPriceChgPct: -0.73 },
    { stockId: 57, symbol: "CVX", name: "Chevron", marketCap: 280000000000, industry: "Energy", price: 0, marketPriceChgPct: -0.69 },
    { stockId: 58, symbol: "COP", name: "ConocoPhillips", marketCap: 130000000000, industry: "Energy", price: 0, marketPriceChgPct: -0.85 },
    { stockId: 59, symbol: "GE", name: "GE Aerospace", marketCap: 180000000000, industry: "Industrials", price: 0, marketPriceChgPct: -0.64 },
    { stockId: 60, symbol: "CAT", name: "Caterpillar", marketCap: 180000000000, industry: "Industrials", price: 0, marketPriceChgPct: -5.63 },
    { stockId: 61, symbol: "RTX", name: "RTX", marketCap: 160000000000, industry: "Industrials", price: 0, marketPriceChgPct: 0.75 },
    { stockId: 62, symbol: "BA", name: "Boeing", marketCap: 110000000000, industry: "Industrials", price: 0, marketPriceChgPct: -0.40 },
